...
test('drawer render', async () => {
  render(
    ...
    <CategoryContext.Provider value={{currCat, dimensions, subList, setSub, setSearch, setCatList, setSubList, catList, search, filList, setFilList, setCategory, setFilter}}>
  <Drawer/>
